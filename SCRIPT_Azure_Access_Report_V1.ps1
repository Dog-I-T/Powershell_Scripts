<#
    .DESCRIPTION
        GET the following information an Azure tenant and export to CSV files,
            - AzureAD Directory Role assignments
            - Azure Subscription Access (All Subscrtipions)
...
$ReportFile1 = "$($Company)_AzureAD_DirectoryRoles_Report_$(get-date -format dd_MM_yyyy).csv"
$ReportFile2 = "$($Company)_Azure_SubscriptionAccess_Report_$(get-date -format dd_MM_yyyy).csv"
